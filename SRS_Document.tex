...
\begin{itemize}
    ...
    \item Must support RTL (Right-to-Left) for Arabic language
...
\begin{infobox}{Shipping Address}
    ...
    \textbf{Input:} Address text (optional, default: "استلام من الفرع")
...
\begin{itemize}
    \item \textbf{Language:} Arabic (RTL support)
